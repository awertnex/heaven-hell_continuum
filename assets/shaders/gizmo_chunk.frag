...
void main()
{
    ...
    float light_influence = (vertex_color.r + vertex_color.g + vertex_color.b) / 3.0;
    light_influence *= vertex_color.a * distance * (1.0 - normalize(vec3(1.0, camera_distance, 0.0)).x);

    color.rgb = vertex_color.rgb * light_influence * vertex_color.a;
