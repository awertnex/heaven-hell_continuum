...
void main()
{
    ...
    vec2 vs_offset = vec2(-offset.x, offset.y) * ndc_scale * texture_scale;
    vec2 vs_alignment = vec2(alignment.x, -alignment.y) * 0.5;
    ...
    vs_tex_coords = vec2(a_tex_coords.s, a_tex_coords.t);
}
