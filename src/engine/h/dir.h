 ...
 *
 * overwrite TRUE will copy directory at path's contents into directory at destination;
 * overwrite FALSE will copy directory at path into directory at destination;
 *
 * return non-zero on failure;
 */
