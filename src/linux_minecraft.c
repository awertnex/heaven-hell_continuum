...
void update_debug_strings() {
    ...
    snprintf(strBlockCount, 32,         "BLOCKS: %ld",              world_stats.blockCount);
    snprintf(strQuadCount, 32,          "QUADS: %ld",               world_stats.quadCount);
    snprintf(strTriCount, 32,           "TRIS: %ld",                world_stats.quadCount * 2);
    snprintf(strVertexCount, 32,        "VERTICES: %ld",            world_stats.quadCount * 6);
}
